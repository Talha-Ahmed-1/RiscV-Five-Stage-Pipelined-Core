...
#endif
#include <iostream>
class TopPipeline_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    TopPipeline_api_t(VTopPipeline* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["TopPipeline.reset"] = 0;
    }
#if VM_TRACE
...
static TopPipeline_api_t * _Top_api;
...
int main(int argc, char **argv, char **env) {
    ...
    VTopPipeline* top = new VTopPipeline;
    std::string vcdfile = "test_run_dir/examples/TopPipeline/TopPipeline.vcd";
